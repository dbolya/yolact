...
#COCO_CLASSES = ('mianlie', 'quejiao', 'louxianquan')
COCO_CLASSES = ('mianlie', 'quejiao', 'louxianquan', 'canfen', 'dianji')
...
hrnet18_backbone = backbone_base.copy({
    'name': 'HRNet18',
    'path': 'hrnetv2_w18-00eb2006.pth',
    'type': HRNet,
    'args': (hrnet18_arch, ),
    'transform': hrnet_transform,
...
# hrnet32_backbone = backbone_base.copy({
#     'name': 'HRNet32',
...
#     'max_iter': 800000,
    'lr_steps': (14000, 30000, 35000, 37500),
    'max_iter': 40000,   
...
####(5) add config file#####
yolact_hrnet18_config = yolact_base_config.copy({
    'name': 'yolact_hrnet18',
    'backbone': hrnet18_backbone.copy({
        'selected_layers': [2],
